 ...
 * 
 */
@WebServiceClient(name = "CartServiceImplService", targetNamespace = "http://services.lab3/", wsdlLocation = "http://localhost:8080/cartservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARTSERVICEIMPLSERVICE_QNAME = new QName("http://services.lab3/", "CartServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/cartservice?wsdl");
    ...
    public CartService getCartServiceImplPort() {
        return super.getPort(new QName("http://services.lab3/", "CartServiceImplPort"), CartService.class);
    }
    ...
    public CartService getCartServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.lab3/", "CartServiceImplPort"), CartService.class, features);
    }
